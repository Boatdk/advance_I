...
create_project -name segment -dir "C:/Users/comeng/Desktop/lab5/segment/planAhead_run_1" -part xc3s200tq144-4
set_param project.pinAheadLayout yes
set srcset [get_property srcset [current_run -impl]]
set_property target_constrs_file "segment.ucf" [current_fileset -constrset]
set hdlfile [add_files [list {segment.v}]]
set_property file_type Verilog $hdlfile
set_property library work $hdlfile
set_property top segment $srcset
